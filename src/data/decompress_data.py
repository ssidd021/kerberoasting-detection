...
if __name__ == "__main__":
    ...
    dc_sync_path = data_dir + "dc_sync.csv"
    ...
    brute_force_path = data_dir + "brute_force.csv"
    ...
    remote_process_injection = data_dir + "remote_process_injection.csv"
